 ...
 */
public class Line {
    public String drawLine(List<String> params, String canvasString){
        ...
        validateLineParams(x1, y1, x2, y2, canvas);
        canvas = painter.drawLine(x1, y1, x2, y2, canvas);
    ...
    private void validateLineParams(int x1, int y1, int x2, int y2, String[][] canvas){
        if(x1 != x2 && y1 != y2){
            throw new InvalidInputException("Please make sure x1 = x2 or y1 = y2 to draw a line");
        }
